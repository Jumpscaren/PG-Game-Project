...
{
public:
	static void RegisterInterface(CSMonoCore* mono_core, const DeferedMethodIndex add_physic_object_index, const DeferedMethodIndex add_polygon_collider_index, const DeferedMethodIndex remove_polygon_collider_index);
...
private:
	static DeferedMethodIndex s_add_polygon_collider_index;
	static DeferedMethodIndex s_add_physic_object_index;
	static DeferedMethodIndex s_remove_polygon_collider_index;
};